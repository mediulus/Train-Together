---
timestamp: 'Wed Oct 15 2025 15:01:06 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251015_150106.a34d7072.md]]'
content_id: 35ee6674ed9e9163e321c3eda2050cf08456cc7d8964f8c63bbfec330a86c748
---
...
class MockTicket {
  constructor(private payload: MockPayload | null) {}
...
class MockOAuth2Client extends OAuth2Client {
  ...
  async verifyIdToken(options: { idToken: string; audience: string }) {
    ...
    switch (options.idToken) {
      ...
      case "invalid-token":
        return new MockTicket(null); // Simulate a token that Google cannot verify
