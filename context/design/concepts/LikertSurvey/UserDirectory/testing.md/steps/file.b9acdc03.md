...
content_id: b9acdc039f97390c3d8c2ddfe23a744d4c434ece7872272f7c1564435cbedbbd
---
 ...
 */
interface SurveyDoc {
  _id: Survey; // MongoDB automatically adds _id, but we use freshID for consistency with concept ID type
  author: Author;
  title: string;
  scaleMin: number;
  scaleMax: number;
